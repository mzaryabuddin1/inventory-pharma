      <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
          <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
              <div class="dropdown profile-element">
                <img
                  ...
                  src="<?= base_url() ?>theme/img/profile_small.jpg"
                />
            ...
            <li>
              <a href="#"
                ><i class="fa fa-edit"></i> <span class="nav-label">Forms</span
                ><span class="fa arrow"></span
              ></a>
              <ul class="nav nav-second-level collapse">
            ...
            <li>
              <a href="#"
                ...
                ><span class="label label-info float-right">NEW</span></a
              >
              <ul class="nav nav-second-level collapse">
            ...
            <li>
              <a href="css_animation.html"
                ...
                ><span class="label label-info float-right">62</span></a
              >
            </li>
