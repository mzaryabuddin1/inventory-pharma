              ...
              <div class="ibox">
                ...
                <div class="ibox-content">
                  <form method="get">
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label"
                        ...
                        <small class="text-navy"
                          >Normal Bootstrap elements</small
                        ></label
                      >
                      ...
                      <div class="col-sm-10">
                        <div>
                          <label>
                            <input type="checkbox" value="" /> Option one is
                    ...
                    <div class="form-group row">
                      <label class="col-sm-2 col-form-label"
                        >Checkboxes &amp; radios <br /><small class="text-navy"
                          >Custom elements</small
                        ></label
                      >
                      ...
                      <div class="col-sm-10">
                        <div class="i-checks">
                          <label>
                            <input type="checkbox" value="" /> <i></i> Option
                            one
                          </label>
                        </div>
                        <div class="i-checks">
